...
import { Settings, Archive, BookOpen, Loader2 } from "lucide-react";
...
export default function Home() {
  ...
  const archivedArticles = articles?.filter(a => a.isRead) || [];
      ...
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-xl tracking-tight hidden sm:block">Pocket Clone</span>
          </div>
...
function EmptyState({ type }: { type: 'unread' | 'archive' }) {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h3 className="text-xl font-bold text-foreground mb-2">
        {type === 'unread' ? "You're all caught up!" : "Archive is empty"}
      </h3>
